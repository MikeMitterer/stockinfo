...
| **T-38** Pflichtfelder im Vertrag | T-36; Vokabular-Entscheidung Mike | Drei der fünf Befunde aus dem UI-Lauf waren **derselbe** Fehler: Ein Wert fehlte, und nichts hat gefragt. Name leer, Gattung leer — und weil die Gattung leer war, wurde die Metadatenquelle nie befragt. Ohne eine Regel, welche Felder eine erfolgreiche Antwort tragen muss, ist die zentrale Zusage des Plugin-Systems nicht prüfbar. Von Mike ausdrücklich entschieden (`name` und `instrument_type` sind Pflicht), von Codex als eigener enger Gate zugeschnitten. | **Gate** |
