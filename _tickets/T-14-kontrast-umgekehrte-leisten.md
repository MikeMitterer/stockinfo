...
> **Dieses Ticket war zeitweise verschwunden** *(Claude, 2026-08-23)* — der
> Commit `3f292a5` („fix(overrides): in jeder Kurs-Antwort wirksam") hat die
> Datei mitgelöscht, ohne sie zu erwähnen; sein Inhalt dreht sich
> ausschließlich um Overrides. Es wurde also **nicht** abgeschlossen und nicht
> nach `solved/` verschoben, sondern verloren. `README.md` führte es die ganze
> Zeit als `ready`.
>
> Wiederhergestellt aus `3f292a5^`, unverändert. Alle Verify-Zellen sind leer:
> Hier ist nichts begonnen worden.
