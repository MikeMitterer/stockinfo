...
| 2b6h | statische Dateien im Pending-Zustand | der Test **baut das Dashboard** und fordert *jede* real ausgelieferte Wurzeldatei und jedes Asset an — insbesondere `/stockinfo-icon.svg`, das `index.html:6` als FavIcon anfordert. Keine handgepflegte Kopie von `dashboard/dist`; unbekannte Pfade und Fach-APIs bleiben gesperrt | | |
