...
| 2b6b | `/ready` in Phase 1 | antwortet **`503`** mit `migration_pending` — Bedeutung, Modell und README bleiben unverändert. Der Docker-`HEALTHCHECK` zieht auf einen eigenen, migrationstauglichen Endpunkt um | | |
