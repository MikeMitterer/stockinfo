...
`CODEX-REVIEW-AUTOMATION.md` und die nötigen Review-Muster.
...
2. Beachte CLAUDE.md. Lies bei tatsächlicher Arbeit _tickets/CODEX-REVIEW-AUTOMATION.md, die zur Autorenschaft passende Mustersammlung (_tickets/CODEX-REVIEW-PATTERNS.md für Codex-Arbeit, _tickets/CLAUDE-REVIEW-PATTERNS.md für Claude-Arbeit; bei gemischter Autorenschaft beide) und das aktive Ticket. ticket muss als Datei direkt im Board-Root liegen, priority_ticket entsprechen und in priority_chain stehen; sonst portfolio_mismatch melden und stoppen.
