...
export const de = {
  ...
  exchanges: {
    ...
    colExchange: 'Handelsplatz',
    default: 'Standard',
    penceNote: 'London notiert häufig in Pence (1/100 GBP).',
    mic: 'MIC',
    support: 'Kursquelle',
    reload: 'Neu laden',
    search: 'MIC, Handelsplatz oder Quelle suchen',
    empty: 'Keine Handelsplätze gefunden.',
    unspecified: 'Nicht angegeben',
    noSupport: 'Im aktuellen Profil nicht abgedeckt',
    unspecifiedHint: 'Für diese Kursquellen ist die Börsenabdeckung unbekannt.',
    yamlRefreshInfo: 'Wenn du in der YAML-Datei Kurse für weitere Handelsplätze einträgst, klicke auf „Neu laden“. Danach erscheinen die zusätzlich abgedeckten MICs.',
    sourceInfo: 'Über die Kursquellen',
    marketInfo: 'Die Quelle bietet Kurse für die zugeordneten Handelsplätze an. Für einzelne Wertpapiere können Kurse fehlen.',
    inventoryInfo: 'Die Quelle liefert ausschließlich hinterlegte Kurse oder den jüngsten gepflegten Schlusskurs. Das bedeutet keine allgemeine Abdeckung der Börse. Im reinen YAML-Profil gibt es keine Online-Abfrage.',
    showUnavailable: 'Nicht abgedeckte Börsen anzeigen',
    regions: {
      germany: 'Deutschland',
      usa: 'USA',
      europe: 'Europa',
