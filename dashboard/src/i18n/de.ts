...
export const de = {
  ...
  exchanges: {
    title: 'Handelsplätze',
    hint: 'Der Katalog stammt aus dem Core und den konfigurierten Plugins. Unterstützung ist eine Angabe der Quelle, keine Garantie für jeden Kursabruf. App-Suffixe sind keine Anbieter-Symbole.',
    colSuffix: 'App-Suffix',
    colExchange: 'Handelsplatz',
    colRegion: 'Region',
    colCurrency: 'Währung',
    noSuffix: 'nicht festgelegt',
    collector: 'Sammelcodes',
    default: 'Standard',
    penceNote: 'London notiert häufig in Pence (1/100 GBP).',
    mic: 'MIC',
    support: 'Quellen und Rollen',
    reload: 'Neu laden',
    ...
    declared: 'Deklariert',
    inactive: 'Inaktiv',
    inventory: 'Bestandsabhängig',
    unspecified: 'Nicht angegeben',
    noSupport: 'Keine Unterstützung deklariert.',
    unspecifiedHint: 'Diese Quellen machen für die genannten Rollen keine MIC-Angabe. Ihre Abdeckung ist daher unbekannt.',
    collectorHint: 'Ein Sammelcode umfasst mehrere Handelsplätze und ist selbst kein MIC.',
    members: 'Mitglieder',
    regions: {
      germany: 'Deutschland',
      usa: 'USA',
