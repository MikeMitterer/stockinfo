...
export const en = {
  ...
  exchanges: {
    ...
    hint: 'The catalog comes from the core and configured plugins. Coverage is declared by the source; it does not guarantee every quote request. App suffixes are not vendor symbols.',
    colSuffix: 'App suffix',
    colExchange: 'Trading venue',
    colRegion: 'Region',
    colCurrency: 'Currency',
    noSuffix: 'not assigned',
    collector: 'Collector codes',
    default: 'Default',
    penceNote: 'London often trades in pence (1/100 GBP).',
    mic: 'MIC',
    support: 'Sources and roles',
    reload: 'Reload',
    ...
    declared: 'Declared',
    inactive: 'Inactive',
    inventory: 'Inventory-dependent',
    unspecified: 'Unspecified',
    noSupport: 'No coverage declared.',
    unspecifiedHint: 'These sources provide no MIC declaration for the listed roles. Their coverage is unknown.',
    collectorHint: 'A collector code covers multiple venues and is not itself a MIC.',
    members: 'Members',
    regions: {
      germany: 'Germany',
      usa: 'USA',
