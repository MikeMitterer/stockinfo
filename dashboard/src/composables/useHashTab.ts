...
export const SETTINGS_TABS: SettingsTab[] = ['appearance', 'language', 'backups', 'environment', 'links']
...
/** Direktlink zu den Erläuterungen einer Kursquelle. */
export function quoteSourceHref(source: string): string {
